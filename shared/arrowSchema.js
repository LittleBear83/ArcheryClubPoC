export const ARROW_MATERIAL_OPTIONS = ["aluminium", "carbon", "wood"];

export const ARROW_COLOUR_OPTIONS = [
...
export const ARROW_FLETCHING_COLOUR_OPTIONS = [
  { value: "White", swatch: "#ffffff", borderColor: "rgba(15, 23, 42, 0.24)" },
  { value: "Black", swatch: "#111111" },
  { value: "Red", swatch: "#d62828" },
  { value: "Orange", swatch: "#f77f00" },
...
export const ARROW_NOCK_COLOUR_OPTIONS = [
  { value: "Clear", swatch: "transparent", borderColor: "rgba(255, 255, 255, 0.65)" },
  { value: "White", swatch: "#ffffff", borderColor: "rgba(15, 23, 42, 0.24)" },
  { value: "Black", swatch: "#111111" },
  { value: "Yellow", swatch: "#f4d35e" },
...
export const ARROW_MATERIAL_OPTION_SET = new Set(ARROW_MATERIAL_OPTIONS);
export const ARROW_COLOUR_VALUE_SET = new Set(
  ARROW_COLOUR_OPTIONS.map((option) => option.value),
);
export const ARROW_FLETCHING_COLOUR_VALUE_SET = new Set(
  ARROW_FLETCHING_COLOUR_OPTIONS.map((option) => option.value),
);
export const ARROW_NOCK_COLOUR_VALUE_SET = new Set(
  ARROW_NOCK_COLOUR_OPTIONS.map((option) => option.value),
);
